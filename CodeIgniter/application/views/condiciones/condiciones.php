<div id="centro">
	...
	<h1>Términos y Condiciones de Uso</h1>
		...
		<p>El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en cualquier momento, en caso de que se haya registrado y que sea necesario para la compra de alguno de nuestros productos. grupo3 no asume la responsabilidad en caso de que entregue dicha clave a terceros.</p>
	...
	<div id="politica">
		<h3>LICENCIA</h3>
		<p>Grupo3 a través de su sitio web concede una licencia para que los usuarios utilicen los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>
	...
	<div id="politica">
		...
		<p>Grupo3 reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
	</div>
</div>